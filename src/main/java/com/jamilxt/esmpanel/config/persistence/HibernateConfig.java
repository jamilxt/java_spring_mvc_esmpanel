package com.jamilxt.esmpanel.config.persistence;
...
@EnableJpaRepositories("com.jamilxt.esmpanel.repositories")
    ...
    public SessionFactory createAndGetLocalSessionFactoryBean() {
        if (this.sessionFactory == null) {
            try {
                ...
                configuration.addPackage("com.jamilxt.esmpanel.model");
                for (Class<?> clazz : (new Reflections("com.jamilxt.esmpanel.model")).getTypesAnnotatedWith(Entity.class)) {
